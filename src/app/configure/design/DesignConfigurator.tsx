...
export const DesignConfigurator = ({configId, imageUrl, imageDimensions}: DesignConfiguratorProps) => {
    ...
    const [renderdDimension, setRenderedDimension] = useState({
    ...
    async function saveConfiguration() {
        ...
        try {
            ...
            ctx?.drawImage(
                ...
                actualX,
                actualY,
                renderdDimension.width,
                renderdDimension.height
            )
                                        ...
                                        <div className="mt-3 space-y-4">
                                            {selectableOptions.map((option) =>(
                                                <RadioGroup.Option
                                                    ...
                                                    value ={option}
                                                    className ={({active, checked}) =>
                                                        cn('relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-nonse sm:flex sm:justify-between', {'border-primary': active || checked,})
                                                    } >
